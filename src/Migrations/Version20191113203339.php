 ...
 */
final class Version20191113203339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD filename VARCHAR(255) NOT NULL, DROP image');
        ...
        $this->addSql('ALTER TABLE goodies ADD quantity_sold INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP filename');
        ...
        $this->addSql('ALTER TABLE goodies DROP quantity_sold');
    }
}
